...
<body>
    ...
    <div class="address-bar">Software Programmer | Online Entrepreneur</div>
            ...
            <div class="box">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <h1 class="text-center">
                        I'm Peter Ju, a Programmer.
                    </h1>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/profile.png" alt="Peter's Profile picture">
                    <p>
                        I am a programmer studying Software Design at Queen's University, Kingston Ontario. I enjoy programming web pages, or other things that can be instantly shared and experienced. I also have experience in online entrepreneurship, with interest in integrating web design tools with marketing consumer products.
                        <hr>
                        Please make sure to check out <a href="http://peterju.com/blog/">my blog</a> for full info about upcoming projects or news about what I'm programming.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <p>
                        ...
                        <ul>
                            ...
                            <li>Polishing my PHP skills to tidy up the blog</li>
                        </ul>
                    </p>
                </div>
            </div>
            ...
            <div class="box">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <h2 class="text-center">
                        I'm currently looking for 12 to 16 month internship opportunities related to Software Development.
                    </h2>
                    <hr>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <hr>
                    <ul class="fa-ul">
                        <li><i class="fa-li fa fa-thumbs-o-up"></i>OOP Languages & Large Software Development: C++, Java, Python</i></li>
                        <br>
                        <li><i class="fa-li fa fa-thumbs-o-up"></i>Web & Mobile Development: <i>HTML, JS, PHP, iOS, Android, rapid prototyping</i></li>
                        <br>
                        <li><i class="fa-li fa fa-thumbs-o-up"></i>Scripting & Testing: <i>Linux, BASH, test automation, determining test cases</i></li>
                        <br>
                        <li><i class="fa-li fa fa-thumbs-o-up"></i>IDEs, Tools, Frameworks: <i>Eclipse, Xcode, Bootstrap, MySQL, FTP, Wikis, UML</i></li>
                        <br>
                        <li><i class="fa-li fa fa-thumbs-o-up"></i><i>Developing and launching fully-functional websites and applications</i></li>
                    ...
                    <h4><a href="http://sites.cs.queensu.ca/courses/cisc235/#Personnel">Teaching Assistant (2015-Present)</a><small class="pull-right">Kingston, ON</small></h4>
                    <p>
                    ...
                    <h4><a href="http://compsasiteservices.com/team.php">Compsa Site Services (2014-Present)</a><small class="pull-right">Kingston, ON</small></h4>
                    <p>
                    ...
                    <h4>ThisIsWhyImHungry (2013-2014)<small class="pull-right">Vancouver, BC</small></h4>
                    <p>
                    ...
                    <p>
                        Software Architect for Flockr - Coming Soon!
                    </p>
                    <p>
                        Lead Game Desinger for Hockey2d - Coming Soon!
                    </p>
                    <hr>
                    <h2>
                        Github?
            ...
            <div class="box">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    <h2>Bachelor of Computing Honours in Software Design
                    <br>
                    Queen's University
                    <br>
                    <small class="pull-right">Kingston, ON</small></h4>
                    <p>
